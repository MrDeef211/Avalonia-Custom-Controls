# Avalonia UI Controls Library

Библиотека продвинутых и гибких элементов управления для Avalonia UI, созданная для ускорения разработки сложных интерфейсов. Она предоставляет готовые, глубоко настраиваемые компоненты, которые покрывают большинство типовых задач: от работы с данными и визуализации до интерактивного масштабирования.
...
## Ключевые возможности
 ...
 - Минимальный код – большинство контролов работают на основе атрибутов и привязок.

 - Глубокая кастомизация – стилизация как через StyledProperty (цвета, шрифты, размеры), так и через CSS-подобные классы для глобального переопределения.

 - Интерактивность – встроенная поддержка валидации, команд, анимации и клавиатурного управления.

 - Реактивность – все компоненты легко интегрируются с ReactiveUI и поддерживают двустороннюю привязку.
